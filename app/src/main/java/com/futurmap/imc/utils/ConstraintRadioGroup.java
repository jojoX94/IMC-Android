package com.futurmap.imc.utils;
...
public final class ConstraintRadioGroup extends ConstraintHelper {
    ...
    ArrayList<RadioButton> m_vRadioButtons = new ArrayList<>();
    private @Nullable
    OnCheckedChangeListener m_listenerOnCheckedChange;
    private boolean m_bSkipCheckingViewsRecursively = false;
    private int m_nCurrentSelectedViewId = -1;
    private final @NonNull
    CompoundButton.OnCheckedChangeListener m_listenerRadioButton =
    ...
    //////////////////////////////////////////////
    public ConstraintRadioGroup(Context ctx) {
        super(ctx);
    }
